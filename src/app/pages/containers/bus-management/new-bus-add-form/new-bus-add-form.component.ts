...
@Component({
  selector: 'app-new-bus-add-form',
  templateUrl: './new-bus-add-form.component.html',
  styleUrls: ['./new-bus-add-form.component.scss']
})
export class NewBusAddFormComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.busDetailsForm.invalid) {
      ...
      this.api.addBusDetails(this.busDetailsForm.value).subscribe((data) => {
        console.log(data)
